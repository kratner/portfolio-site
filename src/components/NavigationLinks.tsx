  ...
  return (
    ...
    <ul className="nav">
      <li>
        ...
        >
          <FontAwesomeIcon icon={faStore} size={size as any} className="nav-icon" />
        </a>
      </li>
      <li>
        <a
        ...
        >
          <FontAwesomeIcon icon={faCode} size={size as any} className="nav-icon" />
        </a>
      </li>
      <li>
        <a
          ...
          title="Contact Me"
        >
          <FontAwesomeIcon icon={faEnvelope} size={size as any} className="nav-icon" />
        </a>
      </li>
      <li>
        <PopupWindow
          linkText={<FontAwesomeIcon icon={faMusic} size={size as any} className="nav-icon" />}
